...
import { fetchGetScore, fetchSetScore, fetchSetScoreProgressBar } from "../../../redux/slices/user.js"
...
const E3 = () => {
    ...
    sortedScore.push(score?.data?.third)

    console.log(sortedScore && sortedScore[0])

    const check =async () =>  {
        if (iden == 'x' && (s == 5) && (operator == '+')) {
            setIsTrue('yes')
        ...
        <Container fluid>
            <Row>
                ...
                <Col md={'10'} className="profile-main-panel" style={{
                    ...
                    <h2 style={{ color: '#001845' }}>{sortedName[0].name + ". " + 'Тапсырма: 3 '}
                                            ...
                                            <Row >
                                                <Col className="col-12">
                                                    <p style={{ color: '#001845', fontSize: '18px' }}>
                                                        Екі айнымалыны пайдаланып 5 + 10 қосындысын көрсетіңіз: <code>x</code> және <code>y</code> .
                                                    </p>
                                                </Col>
                                                <Col className="col-12">
                                                    <div className="" style={{
                                                        ...
                                                        <Row>
                                                            <Col className="col-auto d-flex column justify-content-end">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    className="identificator-input" style={{ width: '30px' }} />
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            ...
                                                            <Col className="col-auto d-flex column justify-content-start">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    className="number-input" style={{ width: '30px' }} />

                                                            </Col>
                                                            <hr style={{ color: 'transparent' }} />
                                                            <Col className="col-auto d-flex column justify-content-end">
                                                                <code>var</code>&nbsp;&nbsp;&nbsp;
                                                                <div style={{ color: 'white', fontSize: '18px', fontWeight: '600' }}>&nbsp;y &nbsp;&nbsp; = &nbsp;&nbsp; 10</div>
                                                            </Col>
                                                            <hr style={{ color: 'transparent' }} />
                                                            <Col className="col-auto d-flex column justify-content-end">
                                                                <code>var</code>&nbsp;&nbsp;&nbsp;
                                                                <div style={{ color: 'white', fontSize: '18px', fontWeight: '600' }}>&nbsp;document.getElementById("demo").innerHTML &nbsp;&nbsp; = &nbsp;&nbsp; x  &nbsp;&nbsp;</div>
                                                                <input type="text"
                                                                    onChange={(event) => {
                                                                    ...
                                                                    style={{ width: '20px' }} />
                                                                <div style={{ color: 'white', fontSize: '18px', fontWeight: '600' }}>&nbsp;&nbsp; y</div>
                                                            </Col>
                                                        </Row>
                                                    </div>
                                                </Col>
